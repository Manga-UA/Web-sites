...
const CatalogList = observer(() => {
	const { titles, theme, genresTitle } = useContext(Context);
...
// 	// titlesArray.genreTitle.map((genre)=>{
// 	// 	console.log(genre.name_genre);
// 	// })

// 	const fetchGenreInTitle = () => {
// 		const titleGenres = titles.titles.map((title) => {
// 			const keyTitleGenres = genresTitle.genresTitle.filter((keyTitleGenre) => keyTitleGenre.titleDatumIdTitle === title.id_title);
// 			const genres = keyTitleGenres.map((keyTitleGenre) => {
// 				const genreTitle = titles.genre.find((genreTitle) => genreTitle.id_genre === keyTitleGenre.genreTitleIdGenre);
// 				return {
// 					id_genre: genreTitle.id_genre,
// 					name_genre: genreTitle.name_genre
// 				};
...
// 					// titlesArray.map((title) => (
// 					// 	titleGenres.map((titleGenre)=>(
// 					// 		titleGenre.genres.map((genre)=>(
