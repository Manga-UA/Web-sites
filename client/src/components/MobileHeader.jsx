...
const MobileHeader = ({ isOpen = false }) => {
	...
	return (
		<React.Fragment>
			...
			<div className={`absolute top-0 right-0 w-full sm:w-1/2 ${theme._theme === LIGHT_THEME ? "bg-main-light" : "bg-main-dark"}  z-20 justify-center min-h-[100%] ${isOpen ? 'flex flex-col items-center space-y-4' : 'hidden'}`}>
