...
export default class TitleManga {
	constructor() {
		...
		this._titles = [
			//{id_title:1,recomend_title:true, name_title:"One Piece",image_title:"becae9a4-7454-494f-b9cd-d8ff4e237358.jpg",description_title: "Це опис нашого тайтлу",date_release_title:"22.02.2022"},
		...
		this._types = [
			/*{ id_type: 1, name_type: "Маньхва" },
			{ id_type: 2, name_type: "Манга" },
			{ id_type: 3, name_type: "Манхва" },
			{ id_type: 4, name_type: "Мальопис" },*/
		]
		this._status = [
		...
		this._genre = [
			/*{ id_type: 1, name_genre: "Action" },
			{ id_type: 2, name_genre: "Romance" },
			{ id_type: 3, name_genre: "Comedy" },
			{ id_type: 4, name_genre: "Fantasy" },
			{ id_type: 5, name_genre: "Mystery" },
			{ id_type: 6, name_genre: "Adventure" },
			{ id_type: 7, name_genre: "Drama" },
			{ id_type: 8, name_genre: "Horror" },
			{ id_type: 9, name_genre: "Sci-Fi" },
			{ id_type: 10, name_genre: "Slice of Life" }*/
		]
		this._chapters = [
