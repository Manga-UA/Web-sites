	...
	return (
		<div className='flex flex-col gap-8'>
			<div className='flex flex-col lg:flex-row gap-3 lg:items-center '>
				...
				<h4 className='text-title-bg'>Тацукі Фуджімото</h4>
			</div>
			<div className='text-text-lg'>
			Тацукі Фудзімото - японський мангака, найбільш відомий своїми роботами Fire Punch і "Людина-бензопила". Закінчив середню школу Нікахо префектури Акіта та університет мистецтв та дизайну Тохоку, навчався на факультеті витончених мистецтв.			</div>
